...
| `--min_length` | 23 | Length of minimizers ua graph is constructed or shall be constructed for. |
...
This option may improve performance for searches using a quorum (cmp. Section [Quorum](#quorum) restriction.
...
| `--random_seed` | 202608141722 | Seed used when replacing IUPAC ambiguity characters. |
...
|---|---:|---:|---:|
| *Build* | Optional | Optional, but either graph or sequence input is required | Optional (Will be ignored) |
