...
int32_t contRightX_Drop_BFS_OnRevComp(const UnitigColorMap<UnitigInfo> &sucUnitig, const uint32_t &iniQoff, uint32_t &hitLen, uint32_t &extLen, const string &q, const uint16_t &mscore, const int16_t &mmscore, const int16_t &X, int32_t &lastSeedTmpScore, list<uint16_t> &extPth, uint32_t &explCount, const uint32_t &quorum, const list<pair<string, size_t>> &searchSet, const bool& advIdx, bool &check, int &numOfBases, const bool &compBases);
...
using shorterTuple = tuple<UnitigColorMap<UnitigInfo>, uint32_t, int32_t, pathList, uint32_t, uint32_t, uint32_t, int32_t>;
//using shorterTuple2 = tuple<UnitigColorMap<UnitigInfo>, uint32_t, int32_t, pathList, uint32_t, uint32_t, uint32_t, int32_t>;

using shorterVector = vector<tuple<UnitigColorMap<UnitigInfo>, uint32_t, int32_t, pathList, uint32_t, uint32_t, uint32_t, int32_t>>;
//using shorterVector2 = vector<tuple<shorterTemp, uint32_t, int32_t, pathList, uint32_t, uint32_t, uint32_t, int32_t>>;
...
int32_t contLeftX_Drop_BFS(const neighborIterator<DataAccessor<UnitigInfo>, DataStorage<UnitigInfo>, false> &prevUni, uint32_t qPos, uint32_t &hitLen, const string &q, const uint16_t &mscore, const int16_t &mmscore, const int16_t &X, const int32_t &lastSeedTmpScore, list<uint16_t> &extPth, uint32_t &explCount, const uint32_t &quorum, const list<pair<string, size_t>> &searchSet, const bool& advIdx);
